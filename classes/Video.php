...
class Video {
    ...
    public static function add($db, $uid, $name, $course, $topic, $descr, $mime, $size) {
        $sql = "INSERT INTO video (id, userid, name, course, topic, description, mime, views) VALUES (:id, :user, :name, :course, :topic, :description, :mime, 0)";
        $sth = $db->prepare ($sql);
